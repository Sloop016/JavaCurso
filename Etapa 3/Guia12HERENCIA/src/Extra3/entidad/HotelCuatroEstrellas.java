...
//Hotel **** Cantidad de Habitaciones, Número de camas, Cantidad de Pisos, Gimnasio,
    ...
    public void calcularPrecioHabitacion() {
         ...
         * gimnasio) + (valor agregado por limosinas). Valor agregado por el
         * restaurante: • $10 si la capacidad del restaurante es de menos de 30
         * personas. • $30 si está entre 30 y 50 personas. • $50 si es mayor de
         * 50. Valor agregado por el gimnasio: • $50 si el tipo del gimnasio es
         * A. • $30 si el tipo del gimnasio es B.
         */
